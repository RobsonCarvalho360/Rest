...
namespace Teste.DAO
{
    public class EnderecoDAO
    {
        ...
        public void InsertDataEndereco(string Rua, int Numero, string Complemento)
        {
        ...
        public void DeleteDataEndereco(int Id)
        {
        ...
        public void UpdateDataEndereco(Endereco endereco)
        {
