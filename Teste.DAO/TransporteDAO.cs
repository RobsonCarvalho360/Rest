...
namespace Teste.DAO
{
    public class TransporteDAO
    {
        ...
        public void InsertDataTransporte(string Tipo_Veiculo, int Ano)
        {
                ...
                new SqlConnection(connectionString))
            {
                ...
                try
                {
                    ...
                    cmd.Parameters.Add("@Tipo_Veiculo", SqlDbType.VarChar, 50).Value = Tipo_Veiculo;
        ...
        public void DeleteDataTransporte(int Id)
        {
        ...
        public void UpdateDataTransporte(Transporte transporte)
        {
            ...
            // Provide the query string with a parameter placeholder.
            string queryString =
                "UPDATE Transporte SET Tipo_Veiculo = @Tipo_Veiculo, Ano = @Ano WHERE IdTransporte = @Id";
                ...
                new SqlConnection(connectionString))
            {
                ...
                try
                {
                    cmd.Parameters.Add("@Id", SqlDbType.Int).Value = transporte.IdTransporte;
                    cmd.Parameters.Add("@Tipo_Veiculo", SqlDbType.VarChar, 50).Value = transporte.Tipo_Veiculo;
                    cmd.Parameters.Add("@Ano", SqlDbType.Int).Value = transporte.Ano  ;
